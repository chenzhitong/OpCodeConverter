...
namespace OpCodeConverter.Test
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            var result = "";
            Program.Analysis(script, false).ForEach(p => result += p + "\r\n");
        ...
        {
            //常见的 verification
            var script = "DCEDrHZSlAddpveSfJa/49P2SuNoDF61D4L1UXCp8b6lna0LQQqQatQ=";
            var result = "";
            Program.Analysis(script, false).ForEach(p => result += p + "\r\n");
            Assert.AreEqual(result, "PUSHDATA1 03ac765294075da6f7927c96bfe3d3f64ae3680c5eb50f82f55170a9f1bea59dad\r\nSYSCALL Neo.Crypto.ECDsaVerify\r\n");
        }
